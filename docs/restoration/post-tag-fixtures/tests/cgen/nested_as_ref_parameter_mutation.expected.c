...
long long __sn__bump(__sn__Counter *);
...
long long __sn__bump(__sn__Counter *__sn__counter) {

    return (*__sn__counter).__sn__value = (*__sn__counter).__sn__value + 1LL;}


int main() {
    __sn__Counter __sn__counter = (__sn__Counter){ .__sn__value = 4LL };
    printf("%lld\n", (long long)(__sn__bump(&__sn__counter)));
    
    printf("%lld\n", (long long)(__sn__counter.__sn__value));
