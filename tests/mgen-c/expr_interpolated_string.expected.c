...
int main() {
    ...
    RtHandleV2 * __sn__msg = ({
            ...
            rt_string_concat_multi_v2(__local_arena__, 3, __is_0__, __is_1__, __is_2__);
        });
    rt_assert_v2((rt_str_length_v2(__sn__msg) == 12LL), rt_arena_v2_strdup(__local_arena__, "expected interpolated string length to be 12"));
main_return:
