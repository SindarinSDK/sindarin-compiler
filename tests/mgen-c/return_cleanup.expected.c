...
RtHandleV2 * __sn__greet(RtArenaV2 *__caller_arena__, RtHandleV2 * __sn__name) {
    ...
    RtHandleV2 * __sn__msg = ({
            ...
            rt_string_concat_multi_v2(__local_arena__, 2, __is_0__, __is_1__);
        });
...
int main() {
    ...
    rt_assert_v2((rt_str_length_v2(__sn__g) == 11LL), rt_arena_v2_strdup(__local_arena__, "expected greeting length to be 11"));
main_return:
