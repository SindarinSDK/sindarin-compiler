...
int main() {
    ...
    (__sn__arr = rt_array_ins_long_h(__local_arena__, ((long long *)rt_managed_pin_array(__local_arena__, __sn__arr)), 1LL, 0LL));
    (__sn__arr = rt_array_ins_long_h(__local_arena__, ((long long *)rt_managed_pin_array(__local_arena__, __sn__arr)), 2LL, 1LL));
    (__sn__arr = rt_array_ins_long_h(__local_arena__, ((long long *)rt_managed_pin_array(__local_arena__, __sn__arr)), 3LL, 2LL));
    ({
        char *_str_arg0 = ({
