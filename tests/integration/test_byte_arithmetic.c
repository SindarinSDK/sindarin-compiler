...
int main() {
    ...
    unsigned char __sn__b = 50LL;
    ({
        char *_str_arg0 = ({
        char *_p0 = rt_to_string_byte(__local_arena__, rt_add_long(__sn__a, __sn__b));
    ...
    ({
        char *_str_arg0 = ({
        char *_p0 = rt_to_string_byte(__local_arena__, rt_sub_long(__sn__a, __sn__b));
        rt_str_concat(__local_arena__, _p0, "\n");
    });
        rt_print_string(_str_arg0);
    });
