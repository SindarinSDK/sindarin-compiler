...
int main() {
    ...
    RtHandle __sn__arr = rt_array_create_long_h(__local_arena__, 5, (long long[]){10LL, 20LL, 30LL, 20LL, 10LL});
    ({
        char *_str_arg0 = ({
        char *_p0 = rt_to_string_long(__local_arena__, rt_array_indexOf_long(((long long *)rt_managed_pin_array(__local_arena__, __sn__arr)), 20LL));
