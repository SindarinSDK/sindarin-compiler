...
int main() {
    ...
    RtHandle __sn__arr = rt_array_create_long_h(__local_arena__, 5, (long long[]){10LL, 20LL, 30LL, 40LL, 50LL});
    ({
        char *_str_arg0 = ({
    ...
    ({
        ...
        char *_p1 = rt_to_string_long(__local_arena__, ((long long *)rt_managed_pin_array(__local_arena__, __sn__arr))[1LL]);
        char *_p2 = rt_to_string_long(__local_arena__, ((long long *)rt_managed_pin_array(__local_arena__, __sn__arr))[2LL]);
        char *_p3 = rt_to_string_long(__local_arena__, ((long long *)rt_managed_pin_array(__local_arena__, __sn__arr))[3LL]);
        char *_p4 = rt_to_string_long(__local_arena__, ((long long *)rt_managed_pin_array(__local_arena__, __sn__arr))[4LL]);
        ...
        _r = rt_str_concat(__local_arena__, _r, " ");
        _r = rt_str_concat(__local_arena__, _r, _p4);
        _r = rt_str_concat(__local_arena__, _r, "\n");
        _r;
    });
        rt_print_string(_str_arg0);
