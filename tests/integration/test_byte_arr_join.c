...
int main() {
    ...
    int _return_value = 0;
    RtHandle __sn__b = rt_array_create_byte_h(__local_arena__, 5, (unsigned char[]){1LL, 2LL, 3LL, 4LL, 5LL});
    ({
        char *_str_arg0 = ({
        char *_p0 = rt_array_join_byte(__local_arena__, ((unsigned char *)rt_managed_pin_array(__local_arena__, __sn__b)), ", ");
