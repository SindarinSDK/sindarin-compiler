...
unsigned char __sn__oldThenIncrement(unsigned char *);
unsigned char __sn__freeOps(unsigned char *);
unsigned char __sn__forwardStatic(unsigned char *);
unsigned char __sn__forwardInstance(unsigned char *);
unsigned char __sn__maxBoundary(unsigned char *);
unsigned char __sn__minBoundary(unsigned char *);
unsigned char __sn__read(unsigned char *);
void __sn__freeBump(unsigned char *);
unsigned char __sn__RefOps_staticOps(unsigned char *);
void __sn__RefOps_staticBump(unsigned char *);
unsigned char __sn__RefOps_instancePostfix(__sn__RefOps *, unsigned char *);
void __sn__RefOps_instanceBump(__sn__RefOps *, unsigned char *);
...
unsigned char __sn__oldThenIncrement(unsigned char *__sn__value) {

    return ({
         unsigned char *__sn_place__ = &((*__sn__value));
...
unsigned char __sn__freeOps(unsigned char *__sn__value) {

    unsigned char __sn__add = ({
        unsigned char __sn_rhs__ = __sn__oldThenIncrement(&(*__sn__value));
        unsigned char *__sn_place__ = &((*__sn__value));
        *__sn_place__ = sn_add_byte(*__sn_place__, __sn_rhs__);
        *__sn_place__;
    });

    unsigned char __sn__sub = ({
        unsigned char __sn_rhs__ = (unsigned char)1;
        unsigned char *__sn_place__ = &((*__sn__value));
        *__sn_place__ = sn_sub_byte(*__sn_place__, __sn_rhs__);
        *__sn_place__;
    });

    unsigned char __sn__mul = ({
        unsigned char __sn_rhs__ = (unsigned char)2;
        unsigned char *__sn_place__ = &((*__sn__value));
        *__sn_place__ = sn_mul_byte(*__sn_place__, __sn_rhs__);
        *__sn_place__;
    });

    unsigned char __sn__div = ({
        unsigned char __sn_rhs__ = (unsigned char)2;
        unsigned char *__sn_place__ = &((*__sn__value));
        *__sn_place__ = sn_div_byte(*__sn_place__, __sn_rhs__);
        *__sn_place__;
    });

    unsigned char __sn__rem = ({
        unsigned char __sn_rhs__ = (unsigned char)3;
        unsigned char *__sn_place__ = &((*__sn__value));
        *__sn_place__ = sn_mod_byte(*__sn_place__, __sn_rhs__);
        *__sn_place__;
    });

    unsigned char __sn__old_inc = ({
        unsigned char *__sn_place__ = &((*__sn__value));
        unsigned char __sn_previous__ = *__sn_place__;
        *__sn_place__ = sn_add_byte(__sn_previous__, 1);
        __sn_previous__;
    ...
    return sn_add_byte(sn_add_byte(sn_add_byte(sn_add_byte(sn_add_byte(sn_add_byte(sn_add_byte(__sn__add, __sn__sub), __sn__mul), __sn__div), __sn__rem), __sn__old_inc), __sn__old_dec), (*__sn__value));}


unsigned char __sn__forwardStatic(unsigned char *__sn__value) {
...
unsigned char __sn__forwardInstance(unsigned char *__sn__value) {
...
unsigned char __sn__maxBoundary(unsigned char *__sn__value) {
...
unsigned char __sn__minBoundary(unsigned char *__sn__value) {
...
unsigned char __sn__read(unsigned char *__sn__value) {

    return (*__sn__value);}


void __sn__freeBump(unsigned char *__sn__value) {
...
unsigned char __sn__RefOps_staticOps(unsigned char *__sn__value) {
...
void __sn__RefOps_staticBump(unsigned char *__sn__value) {
...
unsigned char __sn__RefOps_instancePostfix(__sn__RefOps *__sn__self, unsigned char *__sn__value) {
...
void __sn__RefOps_instanceBump(__sn__RefOps *__sn__self, unsigned char *__sn__value) {
...
int main() {
    unsigned char __sn__free_value = (unsigned char)2;
    unsigned char __sn__static_value = (unsigned char)10;
    unsigned char __sn__postfix_value = (unsigned char)5;
    unsigned char __sn__forwarded_static = (unsigned char)1;
    unsigned char __sn__forwarded_instance = (unsigned char)1;
    unsigned char __sn__maximum = (unsigned char)254;
    unsigned char __sn__minimum = (unsigned char)1;
    __sn__Box __sn__direct = (__sn__Box){ .__sn__value = (unsigned char)1 };
    __sn__Wrapper __sn__nested = (__sn__Wrapper){ .__sn__box = (__sn__Box){ .__sn__value = (unsigned char)10 } };
    __sn__RefOps __sn__ops = (__sn__RefOps){  };
    ...
    { sn_auto_str char *__ps__ = ({
            sn_auto_str char *__is_p0__ = sn_str_fmt("%u", (unsigned)(__sn__freeOps(&__sn__free_value)));
            sn_auto_str char *__is_p1__ = sn_strdup(" ");
            sn_auto_str char *__is_p2__ = sn_str_fmt("%u", (unsigned)(__sn__free_value));
            sn_auto_str char *__is_p3__ = sn_strdup(" ");
            sn_auto_str char *__is_p4__ = sn_str_fmt("%u", (unsigned)(__sn__RefOps_staticOps(&__sn__static_value)));
            sn_auto_str char *__is_p5__ = sn_strdup(" ");
            sn_auto_str char *__is_p6__ = sn_str_fmt("%u", (unsigned)(__sn__static_value));
            sn_auto_str char *__is_p7__ = sn_strdup(" ");
            sn_auto_str char *__is_p8__ = sn_str_fmt("%u", (unsigned)(__sn__RefOps_instancePostfix(&__sn__ops, &__sn__postfix_value)));
            sn_auto_str char *__is_p9__ = sn_strdup(" ");
            sn_auto_str char *__is_p10__ = sn_str_fmt("%u", (unsigned)(__sn__postfix_value));
            sn_auto_str char *__is_p11__ = sn_strdup(" ");
            sn_auto_str char *__is_p12__ = sn_str_fmt("%u", (unsigned)(__sn__forwardStatic(&__sn__forwarded_static)));
            sn_auto_str char *__is_p13__ = sn_strdup(" ");
            sn_auto_str char *__is_p14__ = sn_str_fmt("%u", (unsigned)(__sn__forwarded_static));
            sn_auto_str char *__is_p15__ = sn_strdup(" ");
            sn_auto_str char *__is_p16__ = sn_str_fmt("%u", (unsigned)(__sn__forwardInstance(&__sn__forwarded_instance)));
            sn_auto_str char *__is_p17__ = sn_strdup(" ");
            sn_auto_str char *__is_p18__ = sn_str_fmt("%u", (unsigned)(__sn__forwarded_instance));
            sn_auto_str char *__is_p19__ = sn_strdup(" ");
            sn_auto_str char *__is_p20__ = sn_str_fmt("%u", (unsigned)(__sn__maxBoundary(&__sn__maximum)));
            sn_auto_str char *__is_p21__ = sn_strdup(" ");
            sn_auto_str char *__is_p22__ = sn_str_fmt("%u", (unsigned)(__sn__minBoundary(&__sn__minimum)));
            sn_auto_str char *__is_p23__ = sn_strdup(" ");
            sn_auto_str char *__is_p24__ = sn_str_fmt("%u", (unsigned)(__sn__read(&__sn__direct.__sn__value)));
            sn_auto_str char *__is_p25__ = sn_strdup(" ");
            sn_auto_str char *__is_p26__ = sn_str_fmt("%u", (unsigned)(__sn__direct.__sn__value));
            sn_auto_str char *__is_p27__ = sn_strdup(" ");
            sn_auto_str char *__is_p28__ = sn_str_fmt("%u", (unsigned)(__sn__nested.__sn__box.__sn__value));
