...
int main() {
    ...
    long long __sn__upper_bound = 0LL;
    ({
            long long __match_result__;
            ...
            if (__match_subject__ == (-9223372036854775807LL) || __match_subject__ == 9223372036854775807LL) {
                __match_result__ = (__sn__upper_bound = 1LL);
            } else {
                __match_result__ = (__sn__upper_bound = 2LL);
            }
            __match_result__;
        });
    ...
    { sn_auto_str char *__ps__ = ({
            ...
            sn_auto_str char *__is_p14__ = sn_str_fmt("%lld", (long long)(__sn__upper_bound));
            sn_str_concat_multi(15, __is_p0__, __is_p1__, __is_p2__, __is_p3__, __is_p4__, __is_p5__, __is_p6__, __is_p7__, __is_p8__, __is_p9__, __is_p10__, __is_p11__, __is_p12__, __is_p13__, __is_p14__);
        }); sn_println(__ps__); };
