...
static inline __sn__Address *__sn__Address__new(void) {
...
#define sn_auto_ref_Address __attribute__((cleanup(__sn__Address_release)))
...
int main() {
    sn_auto_Address __sn__Address * __sn__a = ({
        __sn__Address *__tmp__ = __sn__Address__new();
