...
uint64_t __sn__oldThenIncrement(uint64_t *);
uint64_t __sn__freeOps(uint64_t *);
uint64_t __sn__forwardStatic(uint64_t *);
uint64_t __sn__forwardInstance(uint64_t *);
uint64_t __sn__maxBoundary(uint64_t *);
uint64_t __sn__minBoundary(uint64_t *);
uint64_t __sn__assignAndRead(uint64_t *, uint64_t);
uint64_t __sn__read(uint64_t *);
void __sn__freeBump(uint64_t *);
uint64_t __sn__RefOps_staticOps(uint64_t *);
void __sn__RefOps_staticBump(uint64_t *);
uint64_t __sn__RefOps_instancePostfix(__sn__RefOps *, uint64_t *);
void __sn__RefOps_instanceBump(__sn__RefOps *, uint64_t *);
...
uint64_t __sn__oldThenIncrement(uint64_t *__sn__value) {

    return ({
         uint64_t *__sn_place__ = &((*__sn__value));
...
uint64_t __sn__freeOps(uint64_t *__sn__value) {

    uint64_t __sn__add = ({
        uint64_t __sn_rhs__ = __sn__oldThenIncrement(&(*__sn__value));
        uint64_t *__sn_place__ = &((*__sn__value));
    ...
    uint64_t __sn__sub = ({
        uint64_t __sn_rhs__ = 1LL;
        uint64_t *__sn_place__ = &((*__sn__value));
        *__sn_place__ = sn_sub_uint(*__sn_place__, __sn_rhs__);
        *__sn_place__;
    });

    uint64_t __sn__mul = ({
        uint64_t __sn_rhs__ = 2LL;
        uint64_t *__sn_place__ = &((*__sn__value));
        *__sn_place__ = sn_mul_uint(*__sn_place__, __sn_rhs__);
        *__sn_place__;
    });
    ...
    uint64_t __sn__div = ({
        uint64_t __sn_rhs__ = 2LL;
        uint64_t *__sn_place__ = &((*__sn__value));
        *__sn_place__ = sn_div_uint(*__sn_place__, __sn_rhs__);
        *__sn_place__;
    });

    uint64_t __sn__rem = ({
        uint64_t __sn_rhs__ = 3LL;
        uint64_t *__sn_place__ = &((*__sn__value));
        *__sn_place__ = sn_mod_uint(*__sn_place__, __sn_rhs__);
        *__sn_place__;
    });

    uint64_t __sn__old_inc = ({
        uint64_t *__sn_place__ = &((*__sn__value));
        uint64_t __sn_previous__ = *__sn_place__;
        *__sn_place__ = sn_add_uint(__sn_previous__, 1);
        __sn_previous__;
    ...
    return sn_add_uint(sn_add_uint(sn_add_uint(sn_add_uint(sn_add_uint(sn_add_uint(sn_add_uint(__sn__add, __sn__sub), __sn__mul), __sn__div), __sn__rem), __sn__old_inc), __sn__old_dec), (*__sn__value));}


uint64_t __sn__forwardStatic(uint64_t *__sn__value) {
...
uint64_t __sn__forwardInstance(uint64_t *__sn__value) {
...
uint64_t __sn__maxBoundary(uint64_t *__sn__value) {
...
uint64_t __sn__minBoundary(uint64_t *__sn__value) {
...
uint64_t __sn__assignAndRead(uint64_t *__sn__value, uint64_t __sn__assigned) {

    (*__sn__value = __sn__assigned);
    

    return (*__sn__value);}


uint64_t __sn__read(uint64_t *__sn__value) {

    return (*__sn__value);}


void __sn__freeBump(uint64_t *__sn__value) {
...
uint64_t __sn__RefOps_staticOps(uint64_t *__sn__value) {
...
void __sn__RefOps_staticBump(uint64_t *__sn__value) {
...
uint64_t __sn__RefOps_instancePostfix(__sn__RefOps *__sn__self, uint64_t *__sn__value) {
...
void __sn__RefOps_instanceBump(__sn__RefOps *__sn__self, uint64_t *__sn__value) {
...
int main() {
    uint64_t __sn__free_value = 2LL;
    uint64_t __sn__static_value = 10LL;
    uint64_t __sn__postfix_value = 5LL;
    uint64_t __sn__forwarded_static = 1LL;
    uint64_t __sn__forwarded_instance = 1LL;
    uint64_t __sn__half = 9223372036854775807LL;
    uint64_t __sn__high = sn_add_uint(__sn__half, 1LL);
    uint64_t __sn__max_minus_one = sn_mul_uint(__sn__half, 2LL);
    uint64_t __sn__max = sn_add_uint(__sn__max_minus_one, 1LL);
    uint64_t __sn__maximum = __sn__max_minus_one;
    uint64_t __sn__minimum = 1LL;
    uint64_t __sn__assigned = 42LL;
    ...
    { sn_auto_str char *__ps__ = ({
            ...
            sn_auto_str char *__is_p20__ = sn_strdup(((__sn__maxBoundary(&__sn__maximum) == __sn__max)) ? "true" : "false");
            sn_auto_str char *__is_p21__ = sn_strdup(" ");
            sn_auto_str char *__is_p22__ = sn_strdup(((__sn__maximum == __sn__max)) ? "true" : "false");
            sn_auto_str char *__is_p23__ = sn_strdup(" ");
            sn_auto_str char *__is_p24__ = sn_str_fmt("%lld", (long long)(__sn__minBoundary(&__sn__minimum)));
            sn_auto_str char *__is_p25__ = sn_strdup(" ");
            sn_auto_str char *__is_p26__ = sn_strdup(((__sn__assignAndRead(&__sn__assigned, __sn__high) == __sn__high)) ? "true" : "false");
            sn_auto_str char *__is_p27__ = sn_strdup(" ");
            sn_auto_str char *__is_p28__ = sn_strdup(((__sn__assigned == __sn__high)) ? "true" : "false");
            sn_auto_str char *__is_p29__ = sn_strdup(" ");
            sn_auto_str char *__is_p30__ = sn_str_fmt("%lld", (long long)(__sn__read(&__sn__direct.__sn__value)));
            sn_auto_str char *__is_p31__ = sn_strdup(" ");
            sn_auto_str char *__is_p32__ = sn_str_fmt("%lld", (long long)(__sn__direct.__sn__value));
            sn_auto_str char *__is_p33__ = sn_strdup(" ");
            sn_auto_str char *__is_p34__ = sn_str_fmt("%lld", (long long)(__sn__nested.__sn__box.__sn__value));
            sn_str_concat_multi(35, __is_p0__, __is_p1__, __is_p2__, __is_p3__, __is_p4__, __is_p5__, __is_p6__, __is_p7__, __is_p8__, __is_p9__, __is_p10__, __is_p11__, __is_p12__, __is_p13__, __is_p14__, __is_p15__, __is_p16__, __is_p17__, __is_p18__, __is_p19__, __is_p20__, __is_p21__, __is_p22__, __is_p23__, __is_p24__, __is_p25__, __is_p26__, __is_p27__, __is_p28__, __is_p29__, __is_p30__, __is_p31__, __is_p32__, __is_p33__, __is_p34__);
        }); sn_println(__ps__); };
