...
RtHandle __sn__build_with_jumps(RtManagedArena *__caller_arena__) {
    ...
    RtHandle __sn__to_d1 = rt_managed_strdup(__local_arena__, RT_HANDLE_NULL, "");
    {
        ...
        char *_r = rt_str_concat(__loop_arena_4__, "[i=", _p0);
        ...
        rt_managed_strdup(__loop_arena_4__, RT_HANDLE_NULL, _r);
                                        ...
                                        (__sn__to_d3 = rt_managed_clone(__loop_arena_2__, __loop_arena_4__, rt_str_concat_h(__loop_arena_4__, RT_HANDLE_NULL, (char *)rt_managed_pin(__loop_arena_4__, rt_str_concat_h(__loop_arena_4__, RT_HANDLE_NULL, (char *)rt_managed_pin(__loop_arena_4__, rt_str_concat_h(__loop_arena_4__, RT_HANDLE_NULL, (char *)rt_managed_pin(__loop_arena_2__, __sn__to_d3), "d4->d3")), (char *)rt_managed_pin(__loop_arena_4__, __sn__tag))), " ")));
                                        (__sn__to_d2 = rt_managed_clone(__loop_arena_0__, __loop_arena_4__, rt_str_concat_h(__loop_arena_4__, RT_HANDLE_NULL, (char *)rt_managed_pin(__loop_arena_4__, rt_str_concat_h(__loop_arena_4__, RT_HANDLE_NULL, (char *)rt_managed_pin(__loop_arena_4__, rt_str_concat_h(__loop_arena_4__, RT_HANDLE_NULL, (char *)rt_managed_pin(__loop_arena_0__, __sn__to_d2), "d4->d2")), (char *)rt_managed_pin(__loop_arena_4__, __sn__tag))), " ")));
                                        (__sn__to_d1 = rt_managed_clone(__local_arena__, __loop_arena_4__, rt_str_concat_h(__loop_arena_4__, RT_HANDLE_NULL, (char *)rt_managed_pin(__loop_arena_4__, rt_str_concat_h(__loop_arena_4__, RT_HANDLE_NULL, (char *)rt_managed_pin(__loop_arena_4__, rt_str_concat_h(__loop_arena_4__, RT_HANDLE_NULL, (char *)rt_managed_pin(__local_arena__, __sn__to_d1), "d4->d1")), (char *)rt_managed_pin(__loop_arena_4__, __sn__tag))), " ")));
                                    }
                                __loop_cleanup_4__:
                            ...
                            (__sn__to_d2 = rt_managed_clone(__loop_arena_0__, __loop_arena_2__, rt_str_concat_h(__loop_arena_2__, RT_HANDLE_NULL, (char *)rt_managed_pin(__loop_arena_2__, rt_str_concat_h(__loop_arena_2__, RT_HANDLE_NULL, (char *)rt_managed_pin(__loop_arena_2__, rt_str_concat_h(__loop_arena_2__, RT_HANDLE_NULL, (char *)rt_managed_pin(__loop_arena_0__, __sn__to_d2), "| collected_d3:(")), (char *)rt_managed_pin(__loop_arena_2__, __sn__to_d3))), ") ")));
                        }
                    __loop_cleanup_2__:
                ...
                (__sn__to_d1 = rt_managed_clone(__local_arena__, __loop_arena_0__, rt_str_concat_h(__loop_arena_0__, RT_HANDLE_NULL, (char *)rt_managed_pin(__loop_arena_0__, rt_str_concat_h(__loop_arena_0__, RT_HANDLE_NULL, (char *)rt_managed_pin(__loop_arena_0__, rt_str_concat_h(__loop_arena_0__, RT_HANDLE_NULL, (char *)rt_managed_pin(__local_arena__, __sn__to_d1), "| collected_d2:(")), (char *)rt_managed_pin(__loop_arena_0__, __sn__to_d2))), ")\n")));
            }
        __loop_cleanup_0__:
...
int main() {
    ...
    int _return_value = 0;
    rt_println("Jump escape test (3 loops):");
    rt_println("Values jump directly from d4 to d3, d2, and d1");
