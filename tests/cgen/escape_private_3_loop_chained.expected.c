            ...
            RtManagedArena *__loop_arena_0__ = rt_managed_arena_create_child(__local_arena__);
            {
                long long __sn__outer_sum = 0LL;
                {
                    ...
                    while (rt_le_long(__sn__j, 2LL)) {
                        ...
                        {
                            long long __sn__middle_sum = 0LL;
                            {
                            ...
                            (__sn__outer_sum = rt_add_long(__sn__outer_sum, __sn__middle_sum));
                        }
                    __loop_cleanup_2__:
                ...
                (__sn__result = rt_add_long(__sn__result, __sn__outer_sum));
            }
        __loop_cleanup_0__:
...
int main() {
    ...
    int _return_value = 0;
    rt_println("Private chained test (3 loops):");
    rt_println("Only primitives escape from private function");
    ...
    if (rt_eq_long(__sn__computed, 1332LL)) {
        {
