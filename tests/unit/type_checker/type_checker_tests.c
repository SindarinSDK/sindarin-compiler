...
#include "type_checker_tests_struct_basic.c"
#include "type_checker_tests_struct_circular.c"
#include "type_checker_tests_struct_native.c"
#include "type_checker_tests_struct_layout.c"
#include "type_checker_tests_struct_packed.c"
#include "type_checker_tests_struct_symbol.c"
#include "type_checker_tests_struct_literal.c"
#include "type_checker_tests_struct_defaults.c"
#include "type_checker_tests_struct_required.c"
#include "type_checker_tests_struct_nested.c"
#include "type_checker_tests_struct_member_access.c"
#include "type_checker_tests_struct_field_assign.c"
#include "type_checker_tests_struct_utility.c"
#include "type_checker_tests_struct_misc.c"
#include "type_checker_tests_struct.c"
#include "type_checker_tests_edge_cases.c"
#include "type_checker_tests_coverage.c"
#include "type_checker_tests_utils.c"
...
void test_type_checker_main()
{
    ...
    test_type_checker_edge_cases_main();
    test_type_checker_utils_main();
    test_type_checker_coverage_main();
}
