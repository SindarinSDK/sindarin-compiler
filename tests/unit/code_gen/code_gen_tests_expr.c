...
static void test_code_gen_binary_expression_string_concat(void)
{
    ...
    const char *expected = get_expected(&arena,
                                  ...
                                  "    __main_arena__ = __local_arena__;\n"
                                  "    int _return_value = 0;\n"
                                  "    RtHandleV2 *__htmp_0__ = rt_arena_v2_strdup(__local_arena__, \"hello\");\n"
                                  "    RtHandleV2 *__htmp_1__ = rt_arena_v2_strdup(__local_arena__, \"world\");\n"
                                  "    RtHandleV2 *__htmp_2__ = rt_str_concat_v2(__local_arena__, __htmp_0__, __htmp_1__);\n"
                                  "    __htmp_2__;\n"
                                  "    goto main_return;\n"
                                  "main_return:\n"
                                  "    rt_arena_v2_condemn(__local_arena__);\n"
...
static void test_code_gen_value_of_char_pointer(void)
{
    ...
    const char *expected = get_expected(&arena,
                                  ...
                                  "    int _return_value = 0;\n"
                                  "    char* __sn__cptr = 0;\n"
                                  "    ((__sn__cptr) ? rt_arena_v2_strdup(__local_arena__, __sn__cptr) : rt_arena_v2_strdup(__local_arena__, \"\"));\n"
                                  "    goto main_return;\n"
                                  "main_return:\n"
                                  "    rt_arena_v2_condemn(__local_arena__);\n"
                                  "    return _return_value;\n"
