...
fn main() {
    let mut source: Vec<SnString> = vec![SnString::from("alpha"), SnString::from("beta")];
...
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&((source)[__sn_index((source).len(), 0)])); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&((source)[__sn_index((source).len(), 1)])); __sn_interpolated.push_str(":"); __sn_interpolated.push_str(&((copied)[__sn_index((copied).len(), 0)])); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&((copied)[__sn_index((copied).len(), 1)])); __sn_interpolated }
))
;
    { let __sn_array_index = __sn_index((source).len(), 0); (source)[__sn_array_index] = SnString::from("changed-source"); };
    { let __sn_array_index = __sn_index((copied).len(), 1); (copied)[__sn_array_index] = SnString::from("changed-copy"); };
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&((source)[__sn_index((source).len(), 0)])); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&((source)[__sn_index((source).len(), 1)])); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&((copied)[__sn_index((copied).len(), 0)])); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&((copied)[__sn_index((copied).len(), 1)])); __sn_interpolated }
))
;
}
