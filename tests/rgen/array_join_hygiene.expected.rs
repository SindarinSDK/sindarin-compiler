...
fn main() {
    ...
    println!("{}", { let __sn_join_raw_index_3 = { let __sn_place = &mut (receiverIndexCalls); let __sn_previous = *__sn_place; let __sn_next = __sn_checked_0(__sn_previous.checked_add(1), "Runtime error: integer overflow in addition"); *__sn_place = __sn_next; __sn_previous }; let __sn_join_raw_index_4 = 0; let __sn_separator_1 = &({ let __sn_join_raw_index_1 = 0; let __sn_join_raw_index_2 = 0; let __sn_join_index_1 = __sn_index((nested).len(), __sn_join_raw_index_1); let __sn_join_index_2 = __sn_index(((nested)[__sn_join_index_1]).len(), __sn_join_raw_index_2); (((nested)[__sn_join_index_1])[__sn_join_index_2]).mutateSeparator() }); let __sn_join_index_3 = __sn_index((nested).len(), __sn_join_raw_index_3); let __sn_join_index_4 = __sn_index(((nested)[__sn_join_index_3]).len(), __sn_join_raw_index_4); __sn_array_join_1(((((nested)[__sn_join_index_3])[__sn_join_index_4]).values).as_slice(), __sn_separator_1.as_str()) });
    ...
    println!("{}", { let __sn_join_owner_1 = produceNested(&mut (producerCalls)); let __sn_join_raw_index_5 = 0; let __sn_join_raw_index_6 = 0; let __sn_separator_1 = &("/".to_string()); let __sn_join_index_5 = __sn_index((__sn_join_owner_1).len(), __sn_join_raw_index_5); let __sn_join_index_6 = __sn_index(((__sn_join_owner_1)[__sn_join_index_5]).len(), __sn_join_raw_index_6); __sn_array_join_1(((((__sn_join_owner_1)[__sn_join_index_5])[__sn_join_index_6]).values).as_slice(), __sn_separator_1.as_str()) });
