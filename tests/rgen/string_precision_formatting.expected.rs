...
fn main() {
    let mut ascii: String = "abcdef".to_string();
    let mut unicode: String = "éclair".to_string();
    println!("{}", { let mut __sn_interpolated = String::new(); __sn_interpolated.push_str("precision="); __sn_interpolated.push_str(&__sn_format_string(&(ascii), 0, false, true, 3)); __sn_interpolated.push_str("/"); __sn_interpolated.push_str(&__sn_format_string(&(ascii), 0, false, true, 0)); __sn_interpolated.push_str("/"); __sn_interpolated.push_str(&__sn_format_string(&(ascii), 0, false, true, 20)); __sn_interpolated });
    println!("{}", { let mut __sn_interpolated = String::new(); __sn_interpolated.push_str("width=|"); __sn_interpolated.push_str(&__sn_format_string(&(ascii), 8, false, true, 3)); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&__sn_format_string(&(ascii), 8, true, true, 3)); __sn_interpolated.push_str("|"); __sn_interpolated });
    println!("{}", { let mut __sn_interpolated = String::new(); __sn_interpolated.push_str("bytes=|"); __sn_interpolated.push_str(&__sn_format_string(&(unicode), 6, false, true, 2)); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&__sn_format_string(&(unicode), 6, true, true, 3)); __sn_interpolated.push_str("|"); __sn_interpolated });
}
