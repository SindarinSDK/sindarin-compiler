...
fn main() {
    ...
    let mut expectedFour: String = { let mut __sn_string = String::new(); __sn_string.push_str(&("X\u{1f}".to_string())); __sn_string.push_str(&("A".to_string())); __sn_string.push_str(&("Y".to_string())); __sn_string };
    let mut expectedSeven: String = { let mut __sn_string = String::new(); __sn_string.push_str(&("X\u{1f}".to_string())); __sn_string.push_str(&("A".to_string())); __sn_string.push_str(&("b".to_string())); __sn_string.push_str(&("0".to_string())); __sn_string.push_str(&("9".to_string())); __sn_string.push_str(&("Y".to_string())); __sn_string };
    let mut expectedLower: String = { let mut __sn_string = String::new(); __sn_string.push_str(&("x\u{1f}".to_string())); __sn_string.push_str(&("a".to_string())); __sn_string.push_str(&("y".to_string())); __sn_string };
    ...
    let mut concatenated: String = { let mut __sn_string = String::new(); __sn_string.push_str(&("X\u{1f}".to_string())); __sn_string.push_str(&("Ab09Y".to_string())); __sn_string };
