...
fn observe_text(counter: &mut i64) -> SnString {
    ...
    return SnString::from_slice(&[0x63, 0x61, 0x6c, 0x6c, 0x65, 0x64]);
}
...
fn main() {
    ...
    let mut text: SnString = SnString::from_slice(&[0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x64]);
