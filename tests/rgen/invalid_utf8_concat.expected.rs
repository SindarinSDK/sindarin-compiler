...
fn main() {
    let mut value: SnString = { let mut __sn_string = SnString::new(); __sn_string.push_str(&(SnString::from_slice(&[0x76, 0x61, 0x6c, 0x69, 0x64]))); __sn_string.push_str(&(SnString::from_slice(&[0xaf]))); __sn_string };
