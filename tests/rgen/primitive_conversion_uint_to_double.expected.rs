...
;
 ...
 == 0.0) && ((one as f64)
 == 1.0)) && ((representative as f64)
 == 42.0)) && ((exact as f64)
 == 9007199254740991.0)) && ((max as f64)
 == ((half as f64)
 * 2.0))))); __sn_interpolated.push_str(" "); __sn_interpolated.push_str(&format!("{}", ((counter == 1) && (called == 42.0)))); __sn_interpolated }
))
;
}
