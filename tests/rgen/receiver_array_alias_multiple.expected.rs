...
impl Buckets {
    fn mix(&mut self, first: &mut Vec<i64>, second: &mut Vec<i64>) -> i64 {
        (first).push(2);
        ((self).right).push((first).len() as i64);
        (second).push(((self).left.clone()).len() as i64);
        return __sn_checked_0((__sn_checked_0((__sn_checked_0((__sn_checked_0((((self).left.clone()).len() as i64).checked_mul(1000), "Runtime error: integer overflow in multiplication")).checked_add(__sn_checked_0((((self).right.clone()).len() as i64).checked_mul(100), "Runtime error: integer overflow in multiplication")), "Runtime error: integer overflow in addition")).checked_add(__sn_checked_0(((first).len() as i64).checked_mul(10), "Runtime error: integer overflow in multiplication")), "Runtime error: integer overflow in addition")).checked_add((second).len() as i64), "Runtime error: integer overflow in addition");
    }
    fn route(&mut self, first: &mut Vec<i64>, second: &mut Vec<i64>) -> i64 {
        return (self).mix(&mut *(first), &mut *(second));
    }
    fn touch(&mut self, first: &mut Vec<i64>, second: &mut Vec<i64>) -> i64 {
        (first).push(4);
        (second).push((first).len() as i64);
        ((self).left).push((second).len() as i64);
        return __sn_checked_0((__sn_checked_0((__sn_checked_0((((self).left.clone()).len() as i64).checked_mul(100), "Runtime error: integer overflow in multiplication")).checked_add(__sn_checked_0(((first).len() as i64).checked_mul(10), "Runtime error: integer overflow in multiplication")), "Runtime error: integer overflow in addition")).checked_add((second).len() as i64), "Runtime error: integer overflow in addition");
    }
    fn __sn_receiver_array_alias_0(&mut self) -> i64 {
        ((self).left).push(2);
        ((self).right).push(((self).left).len() as i64);
        ((self).right).push(((self).left.clone()).len() as i64);
        return __sn_checked_0((__sn_checked_0((__sn_checked_0((__sn_checked_0((((self).left.clone()).len() as i64).checked_mul(1000), "Runtime error: integer overflow in multiplication")).checked_add(__sn_checked_0((((self).right.clone()).len() as i64).checked_mul(100), "Runtime error: integer overflow in multiplication")), "Runtime error: integer overflow in addition")).checked_add(__sn_checked_0((((self).left).len() as i64).checked_mul(10), "Runtime error: integer overflow in multiplication")), "Runtime error: integer overflow in addition")).checked_add(((self).right).len() as i64), "Runtime error: integer overflow in addition");
    }
    fn __sn_receiver_array_alias_1(&mut self) -> i64 {
        return (self).__sn_receiver_array_alias_0();
    }
    fn __sn_receiver_array_alias_2(&mut self) -> i64 {
        ((self).left).push(4);
        ((self).left).push(((self).left).len() as i64);
        ((self).left).push(((self).left).len() as i64);
        return __sn_checked_0((__sn_checked_0((__sn_checked_0((((self).left.clone()).len() as i64).checked_mul(100), "Runtime error: integer overflow in multiplication")).checked_add(__sn_checked_0((((self).left).len() as i64).checked_mul(10), "Runtime error: integer overflow in multiplication")), "Runtime error: integer overflow in addition")).checked_add(((self).left).len() as i64), "Runtime error: integer overflow in addition");
    }
}
...
fn main() {
    ...
    let mut forwarded: Buckets = Buckets { left: vec![1], right: vec![10] };
    println!("{}", (forwarded).__sn_receiver_array_alias_1());
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&(SnString::from_slice(&[0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x65, 0x64, 0x3a]))); __sn_interpolated.push_str(&format!("{}", ((forwarded).left).len() as i64)); __sn_interpolated.push_str(&(SnString::from_slice(&[0x3a]))); __sn_interpolated.push_str(&format!("{}", ((forwarded).right).len() as i64)); __sn_interpolated.push_str(&(SnString::from_slice(&[0x3a]))); __sn_interpolated.push_str(&format!("{}", ((forwarded).left)[__sn_index(((forwarded).left).len(), 1)])); __sn_interpolated.push_str(&(SnString::from_slice(&[0x3a]))); __sn_interpolated.push_str(&format!("{}", ((forwarded).right)[__sn_index(((forwarded).right).len(), 1)])); __sn_interpolated.push_str(&(SnString::from_slice(&[0x3a]))); __sn_interpolated.push_str(&format!("{}", ((forwarded).right)[__sn_index(((forwarded).right).len(), 2)])); __sn_interpolated }));
