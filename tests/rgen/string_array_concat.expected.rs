...
fn main() {
    ...
    println!("{}", { let __sn_array = &(combined); let __sn_separator = &(",".to_string()); __sn_array.join(__sn_separator.as_str()) });
    ...
    println!("{}", { let __sn_array = &(left); let __sn_separator = &(",".to_string()); __sn_array.join(__sn_separator.as_str()) });
    println!("{}", { let __sn_array = &(right); let __sn_separator = &(",".to_string()); __sn_array.join(__sn_separator.as_str()) });
    println!("{}", { let __sn_array = &(combined); let __sn_separator = &(",".to_string()); __sn_array.join(__sn_separator.as_str()) });
}
