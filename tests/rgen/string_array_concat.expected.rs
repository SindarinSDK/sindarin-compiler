...
fn main() {
    ...
    println!("{}", { let __sn_array_0 = &(combined); let __sn_separator_0 = &(",".to_string()); __sn_array_0.join(__sn_separator_0.as_str()) });
    ...
    println!("{}", { let __sn_array_0 = &(left); let __sn_separator_0 = &(",".to_string()); __sn_array_0.join(__sn_separator_0.as_str()) });
    println!("{}", { let __sn_array_0 = &(right); let __sn_separator_0 = &(",".to_string()); __sn_array_0.join(__sn_separator_0.as_str()) });
    println!("{}", { let __sn_array_0 = &(combined); let __sn_separator_0 = &(",".to_string()); __sn_array_0.join(__sn_separator_0.as_str()) });
}
