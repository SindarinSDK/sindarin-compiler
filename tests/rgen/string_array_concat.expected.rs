...
fn main() {
    ...
    { let __sn_array_index = __sn_index((left).len(), 0); (left)[__sn_array_index] = SnString::from_slice(&[0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x64, 0x2d, 0x6c, 0x65, 0x66, 0x74]); };
    { let __sn_array_index = __sn_index((right).len(), 1); (right)[__sn_array_index] = SnString::from_slice(&[0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x64, 0x2d, 0x72, 0x69, 0x67, 0x68, 0x74]); };
