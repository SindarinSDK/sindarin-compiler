...
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&format!("{}", (source)[__sn_index((source).len(), 0)])); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&format!("{}", (source)[__sn_index((source).len(), 1)])); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&format!("{}", (source)[__sn_index((source).len(), 2)])); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&format!("{}", (copied)[__sn_index((copied).len(), 0)])); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&format!("{}", (copied)[__sn_index((copied).len(), 1)])); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&format!("{}", (copied)[__sn_index((copied).len(), 2)])); __sn_interpolated }
))
;
    { let __sn_array_index = __sn_index((source).len(), 0); (source)[__sn_array_index] = false; };
