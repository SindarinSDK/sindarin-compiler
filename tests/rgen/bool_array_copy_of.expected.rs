...
fn main() {
    ...
    println!("{}", { let mut __sn_interpolated = String::new(); __sn_interpolated.push_str(&format!("{}", (copied)[__sn_index((copied).len(), 0)])); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&format!("{}", (copied)[__sn_index((copied).len(), 1)])); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&format!("{}", (copied)[__sn_index((copied).len(), 2)])); __sn_interpolated });
