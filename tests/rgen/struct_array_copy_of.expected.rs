...
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&format!("{}", ((copied)[__sn_index((copied).len(), 0)]).x)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&format!("{}", ((copied)[__sn_index((copied).len(), 0)]).y)); __sn_interpolated.push_str(":"); __sn_interpolated.push_str(&format!("{}", ((copied)[__sn_index((copied).len(), 1)]).x)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&format!("{}", ((copied)[__sn_index((copied).len(), 1)]).y)); __sn_interpolated }
))
;
    ...
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&format!("{}", ((source)[__sn_index((source).len(), 0)]).x)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&format!("{}", ((source)[__sn_index((source).len(), 1)]).y)); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&format!("{}", ((copied)[__sn_index((copied).len(), 0)]).x)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&format!("{}", ((copied)[__sn_index((copied).len(), 1)]).y)); __sn_interpolated }
))
;
}
