...
;
    { let __sn_rhs = __sn_checked_0(1)
; let __sn_place = &mut (result); let __sn_next = __sn_checked_1((*__sn_place).checked_add(__sn_rhs), "Runtime error: integer overflow in addition"); *__sn_place = __sn_next; __sn_next };
    { let __sn_rhs = __sn_checked_div_0(1)
; let __sn_place = &mut (result); let __sn_next = __sn_checked_1((*__sn_place).checked_add(__sn_rhs), "Runtime error: integer overflow in addition"); *__sn_place = __sn_next; __sn_next };
    { let __sn_rhs = __sn_checked_mod_0(1)
; let __sn_place = &mut (result); let __sn_next = __sn_checked_1((*__sn_place).checked_add(__sn_rhs), "Runtime error: integer overflow in addition"); *__sn_place = __sn_next; __sn_next };
    { let __sn_rhs = __sn_runtime_error_0(1)
; let __sn_place = &mut (result); let __sn_next = __sn_checked_1((*__sn_place).checked_add(__sn_rhs), "Runtime error: integer overflow in addition"); *__sn_place = __sn_next; __sn_next };
    print!("{}", result)
;
