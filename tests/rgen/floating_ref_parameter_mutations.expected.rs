...
impl MutationOps {
 ...
 && (*(calls) == __sn_checked(beforeCalls.checked_add(1), "Runtime error: integer overflow in addition")
)
)
 && ok)
);
        ...
        (ok = ((((afterSubtract == 10.0)
 && (*(__sn_next) == 10.0)
)
 && (*(calls) == __sn_checked(beforeCalls.checked_add(2), "Runtime error: integer overflow in addition")
)
)
 && ok)
);
        ...
        (ok = ((((afterMultiply == 30.0)
 && (*(__sn_next) == 30.0)
)
 && (*(calls) == __sn_checked(beforeCalls.checked_add(3), "Runtime error: integer overflow in addition")
)
)
 && ok)
);
 ...
 && (*(calls) == __sn_checked(beforeCalls.checked_add(4), "Runtime error: integer overflow in addition")
)
)
 && ok)
);
