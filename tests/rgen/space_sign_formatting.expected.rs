...
fn main() {
    ...
    println!("{}", { let mut __sn_interpolated = String::new(); __sn_interpolated.push_str("scientific=|"); __sn_interpolated.push_str(&__sn_format_scientific((value) as f64, 2, false, 12, false, false, true, false, false)); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&__sn_format_scientific((negative_value) as f64, 2, true, 12, false, false, true, false, false)); __sn_interpolated.push_str("|"); __sn_interpolated });
    println!("{}", { let mut __sn_interpolated = String::new(); __sn_interpolated.push_str("scientific-zero=|"); __sn_interpolated.push_str(&__sn_format_scientific((value) as f64, 2, false, 12, false, false, true, true, false)); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&__sn_format_scientific((negative_zero) as f64, 2, false, 12, false, false, true, true, false)); __sn_interpolated.push_str("|"); __sn_interpolated });
    println!("{}", { let mut __sn_interpolated = String::new(); __sn_interpolated.push_str("special=|"); __sn_interpolated.push_str(&__sn_format_scientific((infinity) as f64, 2, false, 10, false, false, true, false, false)); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&__sn_format_scientific((nan) as f64, 2, true, 10, false, false, true, false, false)); __sn_interpolated.push_str("|"); __sn_interpolated });
}
