...
fn main() {
    ...
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str("decimal=|"); __sn_interpolated.push_str(&{ let __sn_value = positive; let __sn_rendered = format!("{:+}", __sn_value); if __sn_value < 0 { __sn_rendered } else { __sn_rendered.replacen('+', " ", 1) } }); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&{ let __sn_value = negative; let __sn_rendered = format!("{:+}", __sn_value); if __sn_value < 0 { __sn_rendered } else { __sn_rendered.replacen('+', " ", 1) } }); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&{ let __sn_value = zero_int; let __sn_rendered = format!("{:+}", __sn_value); if __sn_value < 0 { __sn_rendered } else { __sn_rendered.replacen('+', " ", 1) } }); __sn_interpolated.push_str("|"); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str("width=|"); __sn_interpolated.push_str(&{ let __sn_value = positive; let __sn_rendered = format!("{:+6}", __sn_value); if __sn_value < 0 { __sn_rendered } else { __sn_rendered.replacen('+', " ", 1) } }); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&{ let __sn_value = negative; let __sn_rendered = format!("{:+6}", __sn_value); if __sn_value < 0 { __sn_rendered } else { __sn_rendered.replacen('+', " ", 1) } }); __sn_interpolated.push_str("|"); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str("zero=|"); __sn_interpolated.push_str(&{ let __sn_value = positive; let __sn_rendered = format!("{:+06}", __sn_value); if __sn_value < 0 { __sn_rendered } else { __sn_rendered.replacen('+', " ", 1) } }); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&{ let __sn_value = negative; let __sn_rendered = format!("{:+06}", __sn_value); if __sn_value < 0 { __sn_rendered } else { __sn_rendered.replacen('+', " ", 1) } }); __sn_interpolated.push_str("|"); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str("left=|"); __sn_interpolated.push_str(&{ let __sn_value = positive; let __sn_rendered = format!("{:<+6}", __sn_value); if __sn_value < 0 { __sn_rendered } else { __sn_rendered.replacen('+', " ", 1) } }); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&{ let __sn_value = negative; let __sn_rendered = format!("{:<+6}", __sn_value); if __sn_value < 0 { __sn_rendered } else { __sn_rendered.replacen('+', " ", 1) } }); __sn_interpolated.push_str("|"); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str("plus-wins=|"); __sn_interpolated.push_str(&format!("{:+6}", positive)); __sn_interpolated.push_str("|"); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str("unsigned=|"); __sn_interpolated.push_str(&format!("{:6}", unsigned)); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&format!("{:06x}", unsigned)); __sn_interpolated.push_str("|"); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str("fixed=|"); __sn_interpolated.push_str(&{ let __sn_value = value; let __sn_rendered = format!("{:+8.2}", __sn_value); if __sn_value.is_sign_negative() { __sn_rendered } else { __sn_rendered.replacen('+', " ", 1) } }); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&{ let __sn_value = negative_value; let __sn_rendered = format!("{:+8.2}", __sn_value); if __sn_value.is_sign_negative() { __sn_rendered } else { __sn_rendered.replacen('+', " ", 1) } }); __sn_interpolated.push_str("|"); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str("fixed-zero=|"); __sn_interpolated.push_str(&{ let __sn_value = value; let __sn_rendered = format!("{:+08.2}", __sn_value); if __sn_value.is_sign_negative() { __sn_rendered } else { __sn_rendered.replacen('+', " ", 1) } }); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&{ let __sn_value = negative_zero; let __sn_rendered = format!("{:+08.2}", __sn_value); if __sn_value.is_sign_negative() { __sn_rendered } else { __sn_rendered.replacen('+', " ", 1) } }); __sn_interpolated.push_str("|"); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str("scientific=|"); __sn_interpolated.push_str(&__sn_format_scientific((value) as f64, 2, false, 12, false, false, true, false, false)); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&__sn_format_scientific((negative_value) as f64, 2, true, 12, false, false, true, false, false)); __sn_interpolated.push_str("|"); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str("scientific-zero=|"); __sn_interpolated.push_str(&__sn_format_scientific((value) as f64, 2, false, 12, false, false, true, true, false)); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&__sn_format_scientific((negative_zero) as f64, 2, false, 12, false, false, true, true, false)); __sn_interpolated.push_str("|"); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str("special=|"); __sn_interpolated.push_str(&__sn_format_scientific((infinity) as f64, 2, false, 10, false, false, true, false, false)); __sn_interpolated.push_str("|/|"); __sn_interpolated.push_str(&__sn_format_scientific((nan) as f64, 2, true, 10, false, false, true, false, false)); __sn_interpolated.push_str("|"); __sn_interpolated }
))
;
}
