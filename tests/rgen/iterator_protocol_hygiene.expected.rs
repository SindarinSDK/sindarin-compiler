...
fn main() {
    ...
    while __sn_iter_1.hasNext() {
        ...
        __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&(SnString::from_slice(&[0x63, 0x6f, 0x6c, 0x6c, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x3d]))); __sn_interpolated.push_str(&format!("{}", __sn_iter)); __sn_interpolated.push_str(&(SnString::from_slice(&[0x20, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x3d]))); __sn_interpolated.push_str(&format!("{}", __sn_iter_0)); __sn_interpolated.push_str(&(SnString::from_slice(&[0x20, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x3d]))); __sn_interpolated.push_str(&format!("{}", outer_value)); __sn_interpolated.push_str(&(SnString::from_slice(&[0x20, 0x69, 0x6e, 0x6e, 0x65, 0x72, 0x3d]))); __sn_interpolated.push_str(&format!("{}", inner_value)); __sn_interpolated }));
        break;
    }
}
        break;
    ...
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&(SnString::from_slice(&[0x66, 0x69, 0x6e, 0x61, 0x6c, 0x3d]))); __sn_interpolated.push_str(&format!("{}", __sn_iter)); __sn_interpolated.push_str(&(SnString::from_slice(&[0x20, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x2d, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x3d]))); __sn_interpolated.push_str(&format!("{}", __sn_iter_0)); __sn_interpolated.push_str(&(SnString::from_slice(&[0x20, 0x65, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x3d]))); __sn_interpolated.push_str(&format!("{}", evaluations)); __sn_interpolated }));
}
