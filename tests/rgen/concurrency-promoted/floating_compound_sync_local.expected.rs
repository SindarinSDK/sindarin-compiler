...
fn main() {
    ...
    { let __sn_concurrency0_rhs = 1.0; let mut __sn_concurrency0_value = value.lock().unwrap_or_else(|e| e.into_inner()); *__sn_concurrency0_value = *__sn_concurrency0_value + __sn_concurrency0_rhs; __sn_concurrency0_value.clone() };
}
