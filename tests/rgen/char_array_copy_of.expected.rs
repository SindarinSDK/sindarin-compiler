...
fn main() {
    ...
    println!("{}", { let mut __sn_interpolated = String::new(); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 0)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 1)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 2)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 3)], 0, false)); __sn_interpolated });
    println!("{}", { let mut __sn_interpolated = String::new(); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 0)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 1)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 2)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 3)], 0, false)); __sn_interpolated });
    ...
    println!("{}", { let mut __sn_interpolated = String::new(); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 0)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 3)], 0, false)); __sn_interpolated });
    println!("{}", { let mut __sn_interpolated = String::new(); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 0)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 3)], 0, false)); __sn_interpolated });
}
