...
fn main() {
    ...
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&format!("{}", (source).len() as i64)); __sn_interpolated.push_str(":"); __sn_interpolated.push_str(&format!("{}", (copied).len() as i64)); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 0)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 1)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 2)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 3)], 0, false)); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 0)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 1)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 2)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 3)], 0, false)); __sn_interpolated }
))
;
    { let __sn_array_index = __sn_index((source).len(), 0); (source)[__sn_array_index] = '\u{53}'; };
    { let __sn_array_index = __sn_index((copied).len(), 3); (copied)[__sn_array_index] = '\u{43}'; };
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 0)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 3)], 0, false)); __sn_interpolated }
))
;
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 0)], 0, false)); __sn_interpolated.push_str(","); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 3)], 0, false)); __sn_interpolated }
))
;
}
