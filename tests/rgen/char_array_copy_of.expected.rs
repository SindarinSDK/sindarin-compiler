...
fn main() {
    ...
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 0)], 0, false)); __sn_interpolated.push_str(&(SnString::from_slice(&[0x2c]))); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 1)], 0, false)); __sn_interpolated.push_str(&(SnString::from_slice(&[0x2c]))); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 2)], 0, false)); __sn_interpolated.push_str(&(SnString::from_slice(&[0x2c]))); __sn_interpolated.push_str(&__sn_format_character((source)[__sn_index((source).len(), 3)], 0, false)); __sn_interpolated }));
    __sn_println_string(&({ let mut __sn_interpolated = SnString::new(); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 0)], 0, false)); __sn_interpolated.push_str(&(SnString::from_slice(&[0x2c]))); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 1)], 0, false)); __sn_interpolated.push_str(&(SnString::from_slice(&[0x2c]))); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 2)], 0, false)); __sn_interpolated.push_str(&(SnString::from_slice(&[0x2c]))); __sn_interpolated.push_str(&__sn_format_character((copied)[__sn_index((copied).len(), 3)], 0, false)); __sn_interpolated }));
