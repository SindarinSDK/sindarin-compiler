...
int main() {
    sn_auto_thread SnThread * __sn__handle = ({
    ...
    long long __sn__result = ({ sn_auto_thread SnThread *__sync_th__ = __sn__handle; __sn__handle = NULL; sn_thread_join(__sync_th__); long long __sync_val__ = *(long long *)__sync_th__->result; __sync_val__; });
